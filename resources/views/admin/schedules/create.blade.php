    ...
    <div class="p-6 space-y-6 overflow-y-auto">
        <div class="glass-card border-glow rounded-xl p-6 shadow-md">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white deco-line"
                style="--line-color: rgba(99, 102, 241, 0.7)">Tambah Jadwal Pelajaran Baru</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Lengkapi formulir berikut untuk menambahkan jadwal
                pelajaran baru</p>
        </div>
