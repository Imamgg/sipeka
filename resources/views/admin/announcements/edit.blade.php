<x-app-layout>
    <div class="container mx-auto px-6 py-8">
        ...
        <!-- Header Section -->
        <div
            class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-sm border border-gray-200 mb-4 sm:mb-6">
            <div class="p-4 sm:p-8">
                <div class="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div>
                        <h1 class="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">Edit Pengumuman</h1>
                        <p class="text-sm sm:text-base text-gray-600 mt-1">Ubah informasi pengumuman yang telah ada</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            <div class="p-4 sm:p-6">
                <form action="{{ route('admin.announcements.update', $announcement) }}" method="POST"
                    enctype="multipart/form-data" id="announcementForm" class="space-y-4 sm:space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                        ...
                        <div class="lg:col-span-2 space-y-4 sm:space-y-6 lg:space-y-8">
                            ...
                            <div class="bg-gray-50 rounded-xl p-3 sm:p-4 md:p-6">
                                <div class="flex items-center mb-3 sm:mb-4 md:mb-6">
                                    <div
                                        class="w-8 h-8 sm:w-10 sm:h-10 bg-blue-100 rounded-lg flex items-center justify-center mr-2 sm:mr-3 md:mr-4 flex-shrink-0">
                                    ...
                                    <h3 class="text-lg sm:text-xl font-semibold text-gray-900">Informasi Dasar</h3>
                                </div>
                                ...
                                <div class="space-y-4 sm:space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text"
                                            class="w-full px-3 sm:px-4 py-2 sm:py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('title') border-red-300 @enderror"
                                            id="title" name="title"
                                    ...
                                    <div>
                                        ...
                                        <div
                                            ...
                                            <!-- Toolbar -->
                                            <div
                                                class="bg-gray-50 border-b border-gray-200 px-2 sm:px-4 py-1 sm:py-2 overflow-x-auto">
                                                <div class="flex items-center gap-1 sm:gap-2 min-w-max">
                                                    <button type="button"
                                                        class="p-1 sm:p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-200 rounded"
                                                    ...
                                                    <div class="border-l h-4 sm:h-6 mx-1 sm:mx-2"></div>
                                                    <button type="button"
                                                        class="p-1 sm:p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-200 rounded"
                                            ...
                                            <textarea class="w-full px-3 sm:px-4 py-2 sm:py-3 border-0 focus:ring-0 resize-none" id="content" name="content"
                                                rows="6 sm:rows-8" placeholder="Tulis konten pengumuman di sini...">{{ old('content', $announcement->content) }}</textarea>
                                        </div>
                                        @error('content')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                            ...
                            <div class="bg-gray-50 rounded-xl p-3 sm:p-4 md:p-6">
                                <div class="flex items-center mb-3 sm:mb-4 md:mb-6">
                                    <div
                                        class="w-8 h-8 sm:w-10 sm:h-10 bg-green-100 rounded-lg flex items-center justify-center mr-2 sm:mr-3 md:mr-4 flex-shrink-0">
                                    ...
                                    <h3 class="text-lg sm:text-xl font-semibold text-gray-900">Jadwal & Lampiran</h3>
                                </div>
                                ...
                                <div>
                                        ...
                                        <div class="mb-4 p-3 sm:p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                            <div
                                                ...
                                                <div class="flex items-center">
                                                    <svg class="w-6 h-6 sm:w-8 sm:h-8 text-blue-500 mr-2 sm:mr-3 flex-shrink-0"
                                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <div class="min-w-0">
                                                        ...
                                                        <p
                                                            class="text-xs sm:text-sm text-blue-700 truncate max-w-[180px] sm:max-w-xs">
                                                            {{ basename($announcement->attachment) }}</p>
                                                    </div>
                                                </div>
                                                <a href="{{ route('admin.announcements.download', $announcement) }}"
                                                    class="inline-flex items-center justify-center px-2 sm:px-3 py-1.5 sm:py-2 bg-blue-600 text-white text-xs sm:text-sm rounded-lg hover:bg-blue-700 transition-colors whitespace-nowrap">
                                                    <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 mr-1 sm:mr-2 flex-shrink-0"
                                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                    ...
                                    <div
                                        class="flex flex-col justify-center px-4 sm:px-6 pt-5 pb-6 border-2 border-dashed rounded-lg hover:border-gray-400 transition-colors">
                                        <div class="space-y-1 text-center">
                                            <svg class="mx-auto h-10 w-10 sm:h-12 sm:w-12 text-gray-400"
                                            ...
                                            <div
                                                class="flex flex-col sm:flex-row justify-center text-sm text-gray-600">
                                                <label for="attachment"
                                                    class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500 mx-auto sm:mx-0 mb-2 sm:mb-0">
                                                ...
                                                <p class="pl-0 sm:pl-1 text-center sm:text-left">atau drag and drop</p>
                                            </div>
                        ...
                        <div class="lg:col-span-1 space-y-4 sm:space-y-6">
                            ...
                            <div class="bg-gray-50 rounded-xl p-3 sm:p-4 md:p-6">
                                <div class="flex items-center mb-3 sm:mb-4 md:mb-6">
                                    <div
                                        class="w-8 h-8 sm:w-10 sm:h-10 bg-purple-100 rounded-lg flex items-center justify-center mr-2 sm:mr-3 md:mr-4 flex-shrink-0">
                                    ...
                                    <h3 class="text-lg sm:text-xl font-semibold text-gray-900">Target & Prioritas</h3>
                                </div>
                                ...
                                <div class="space-y-3 sm:space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            class="w-full px-2 sm:px-3 py-1.5 sm:py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('is_active') border-red-300 @enderror text-sm sm:text-base"
                                    ...
                                    <div>
                                        <label for="priority"
                                            class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Prioritas</label>
                                        <select
                                            class="w-full px-2 sm:px-3 py-1.5 sm:py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('priority') border-red-300 @enderror text-sm sm:text-base"
                                    ...
                                    <div>
                                        <label for="target"
                                            class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Target
                                            Pengumuman</label>
                                        <select
                                            class="w-full px-2 sm:px-3 py-1.5 sm:py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('target') border-red-300 @enderror text-sm sm:text-base"
                                    ...
                                    <div id="targetClassesDiv"
                                        ...
                                        <label for="class_target"
                                            class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Pilih
                                            Kelas</label>
                                        <select
                                            class="w-full px-2 sm:px-3 py-1.5 sm:py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('class_target') border-red-300 @enderror text-sm sm:text-base"
                                    ...
                                    <div>
                                        <label for="published_at"
                                            class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Waktu
                                            Publikasi</label>
                                        <input type="datetime-local"
                                            class="w-full px-2 sm:px-3 py-1.5 sm:py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('published_at') border-red-300 @enderror text-sm sm:text-base"
                                    ...
                                    <div>
                                        <label for="expires_at"
                                            class="block text-sm font-medium text-gray-700 mb-1 sm:mb-2">Tanggal
                                            Berakhir
                                            (Opsional)</label>
                                        <input type="datetime-local"
                                            class="w-full px-2 sm:px-3 py-1.5 sm:py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('expires_at') border-red-300 @enderror text-sm sm:text-base"
                            ...
                            <div class="space-y-3">
                                <button type="submit"
                                    class="w-full flex items-center justify-center px-3 sm:px-4 py-2 sm:py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transform hover:scale-[1.02] sm:hover:scale-105 transition-all duration-200 shadow-lg text-sm sm:text-base"
                                    id="submitBtn">
                                    <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-1.5 sm:mr-2" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <a href="{{ route('admin.announcements.show', $announcement) }}"
                                    class="w-full flex items-center justify-center px-3 sm:px-4 py-2 sm:py-3 bg-white border text-gray-700 font-semibold rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors text-sm sm:text-base">
                                    <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-1.5 sm:mr-2" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
