    ...
    <div class="p-6 space-y-6 mt-16 overflow-y-auto">
        <div class="glass-card border-glow rounded-xl p-6 shadow-md">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white deco-line"
                style="--line-color: rgba(99, 102, 241, 0.7)">Tambah Siswa Baru</h1>
        ...
        <div class="rounded-xl border p-6 shadow-md">
            ...
            <form action="{{ route('admin.students.store') }}" method="POST" class="space-y-6" id="createForm">
                @csrf
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button type="submit" id="submitBtn"
                        ...
                        <svg class="h-4 w-4 mr-2 hidden" id="loadingIcon" fill="none" viewBox="0 0 24 24">
