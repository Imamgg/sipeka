<x-app-layout>
    ...
    <div class="bg-gradient-to-br from-purple-50 via-white to-indigo-50 border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="text-center">
                ...
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    Lengkapi formulir berikut untuk menambahkan mata pelajaran baru ke dalam sistem kurikulum
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="bg-gradient-to-r from-purple-50 to-indigo-50 p-6 border-b border-gray-200">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Data lengkap untuk mata pelajaran baru</p>
                    </div>
                </div>
            </div>

            <!-- Form Content -->
            <form action="{{ route('admin.subjects.store') }}" method="POST" class="p-6" id="createSubjectForm">
                @csrf
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="code_subject" id="code_subject" value="{{ old('code_subject') }}"
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="4" placeholder="Deskripsi singkat tentang mata pelajaran..."
                            class="w-full rounded-xl border @error('description') border-red-300 focus:border-red-500 focus:ring-red-200 @enderror bg-gray-50 px-4 py-3 text-sm focus:bg-white focus:outline-none focus:ring-2 transition-all duration-200 resize-none">{{ old('description') }}</textarea>
                ...
                <div class="mt-8 flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" id="submitBtn"
                        class="inline-flex items-center px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed">
                        ...
                        <span id="btnText">Simpan Mata Pelajaran</span>
                    </button>
                </div>
            </form>
        </div>
