<x-teacher-layout>
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        <!-- Hero Header Section -->
        <div
            class="relative overflow-hidden bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-800 shadow-xl rounded-2xl mx-6 mt-6 mb-8">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <h1 class="text-4xl font-bold text-white mb-3">
                            Input <span class="text-yellow-300">Nilai Siswa</span>
                        </h1>
                        <p class="text-indigo-100 text-lg">Kelola dan input nilai siswa untuk mata pelajaran yang Anda
                            ampu dengan mudah</p>
                    </div>
            ...
            <div
                ...
                <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900">Filter & Aksi</h3>
                                <p class="text-sm text-gray-500">Filter data nilai berdasarkan kelas dan mata pelajaran
                                </p>
                            </div>
                        </div>
                        <a href="{{ route('teacher.grades.create') }}"
                            class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 border border-transparent rounded-xl font-semibold text-sm text-white uppercase tracking-wide hover:from-emerald-600 hover:to-teal-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div class="space-y-2">
                            <label for="class_filter" class="block text-sm font-semibold text-gray-700">Filter
                                Kelas</label>
                        ...
                        <div class="space-y-2">
                            <label for="subject_filter" class="block text-sm font-semibold text-gray-700">Filter Mata
                                Pelajaran</label>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                        <label for="grade_type_filter" class="block text-sm font-semibold text-gray-700 mb-3">Filter
                            Jenis
                            Nilai</label>
                        <select id="grade_type_filter" name="grade_type"
                            ...
                            <option value="tugas" {{ request('grade_type') == 'tugas' ? 'selected' : '' }}>Tugas
                            </option>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="text-sm text-gray-500">{{ $grade->student->nisn }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                    ...
                    @else
                        <div class="p-12 text-center">
                            ...
                            <p class="text-gray-600 mb-6">Mulai input nilai siswa untuk mata pelajaran yang Anda ampu.
                            </p>
                            <a href="{{ route('teacher.grades.create') }}"
