<x-teacher-layout>
    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        <!-- Hero Header Section -->
        <div
            class="relative overflow-hidden bg-gradient-to-r from-emerald-600 via-teal-600 to-green-800 shadow-xl rounded-2xl mx-6 mt-6 mb-8">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center space-x-4 mb-4">
                            <a href="{{ route('teacher.grades.index') }}"
                                class="p-3 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-xl transition-all duration-200 backdrop-blur-sm">
                        ...
                        <h1 class="text-4xl font-bold text-white mb-3">
                            Tambah <span class="text-yellow-300">Nilai Siswa</span>
                        </h1>
                        <p class="text-emerald-100 text-lg">Input nilai baru untuk siswa dengan mudah dan cepat</p>
                    </div>
                ...
                <div
                    ...
                    <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-emerald-50 to-teal-50">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900">Formulir Input Nilai</h3>
                                <p class="text-sm text-gray-500">Lengkapi form berikut untuk menambahkan nilai siswa</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-3">
                                ...
                                <select id="class_id" name="class_id"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200 @error('class_id') border-red-500 @enderror">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="assessment_date"
                            class="block text-sm font-semibold text-gray-700 mb-3">Tanggal
                            Penilaian</label>
