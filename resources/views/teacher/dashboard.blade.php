        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-indigo-500 to-purple-600 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold">Selamat Datang, {{ $teacher->user->name }}!</h3>
                            <p class="text-indigo-100 mt-2">NIP: {{ $teacher->nip }} |
                                @if ($homeroomClasses->count() > 0)
                                    Wali Kelas: {{ $homeroomClasses->pluck('class_name')->join(', ') }}
                                @else
                                    Guru Mata Pelajaran
                                @endif
                            </p>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-xs text-gray-500">Bimbingan</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-500">Wali Kelas</div>
                                <div class="text-2xl font-bold text-gray-900">{{ $homeroomClasses->count() }}</div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-2xl font-bold text-gray-900">{{ $subjectsCount }}</div>
                                <div class="text-xs text-gray-500">Diampu</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-500">Kehadiran Kelas</div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="p-6">
                                    ...
                                    <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                        ...
                                        <div class="ml-3 flex-1">
                                            ...
                                            <div class="text-xs text-gray-500">
                                                Kelas {{ $schedule->classes->class_name }}
                                            </div>
                                        </div>
                        ...
                        @else
                            <div class="text-center py-8 text-gray-500">
                                ...
                                <p class="mt-2">Tidak ada jadwal mengajar hari ini</p>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-semibold text-gray-900">Input Nilai Terbaru</h3>
                                ...
                                @foreach ($recentGrades as $grade)
                                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                        <div class="flex-1">
                                            ...
                                            <div class="text-xs text-gray-500">
                                                {{ $grade->subject->name }} - {{ ucfirst($grade->type_assessment) }}
                                            </div>
                                        </div>
                        ...
                        @else
                            <div class="text-center py-8 text-gray-500">
                                ...
                                <p class="mt-2">Belum ada nilai yang diinput</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-semibold text-gray-900">Kelas Bimbingan</h3>
                        ...
                        @else
                            <div class="text-center py-8 text-gray-500">
                                ...
                                <p class="mt-2">Tidak ditugaskan sebagai wali kelas</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            @if ($homeroomClasses->count() > 0)
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-6">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-semibold text-gray-900">Ringkasan Absensi Kelas Bimbingan</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                            <div class="text-center">
                                <div class="text-2xl font-bold text-gray-900">{{ $attendanceStats['total_sessions'] }}
                                </div>
                                <div class="text-sm text-gray-600">Total Sesi</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-green-600">{{ $attendanceStats['present_count'] }}
                                </div>
                                <div class="text-sm text-gray-600">Hadir</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-red-600">{{ $attendanceStats['absent_count'] }}
                                </div>
                                <div class="text-sm text-gray-600">Tidak Hadir</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-yellow-600">{{ $attendanceStats['late_count'] }}
                                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-6 gap-4">
                        <a href="{{ route('teacher.students.index') }}"
                            ...
                            <span class="text-sm font-medium text-blue-600">Data Siswa</span>
                        </a>
                        ...
                        <a href="{{ route('teacher.grades.index') }}"
                            ...
                            <span class="text-sm font-medium text-yellow-600">Input Nilai</span>
                        </a>
                        ...
                        <a href="{{ route('teacher.attendance.index') }}"
                            ...
                            <span class="text-sm font-medium text-purple-600">Absensi</span>
                        </a>
            ...
            <!-- Weekly Schedule Overview (if available) -->
            @if ($weeklySchedule->count() > 0)
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-6">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-semibold text-gray-900">Jadwal Mingguan</h3>
                            <a href="{{ route('teacher.schedules.index') }}"
                                class="text-indigo-600 hover:text-indigo-800 text-sm">
                                Lihat Detail
                            </a>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-7 gap-4">
                            ...
                            @foreach ($days as $index => $day)
                                <div class="text-center">
                                    <div class="font-semibold text-gray-900 mb-2">{{ $dayNames[$index] }}</div>
                                    <div class="text-sm text-gray-600">
                                        {{ $weeklySchedule->get($day, collect())->count() }} jadwal
                                    </div>
                                </div>
                            @endforeach
                        </div>
