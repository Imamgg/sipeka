    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600 mt-2">Kelola dan lihat jadwal mengajar Anda</p>
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            @foreach ($todaySchedules as $schedule)
                                <div
                                    ...
                                    <h3 class="font-semibold text-gray-900 mb-2">{{ $schedule->subject->name }}</h3>
            ...
            @endif <!-- Weekly Schedule Table -->
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-8">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-xl font-semibold text-gray-900">Jadwal Mingguan</h2>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($schedules as $schedule)
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="text-sm font-semibold text-gray-900">{{ $schedule->subject->name }}</span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <h3 class="text-lg font-medium text-gray-900 mb-2">Tidak ada jadwal
                                                ditemukan</h3>
                                            <p class="text-gray-500">Silakan hubungi administrator Anda.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <h2 class="text-xl font-semibold text-gray-900 flex items-center">
                            <x-icons.calendar class="w-6 h-6 mr-2" />
                            Ikhtisar Mingguan
                        </h2>
                    </div>
                    <div class="p-6">
                                    ...
                                    <div class="p-3 space-y-2">
                                        @if (isset($schedulesByDay[$day]))
                                            @foreach ($schedulesByDay[$day] as $schedule)
                                                <div
                                                    class="bg-white rounded-md p-3 border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200">
                                        ...
                                        @else
                                            <div class="text-center py-8">
                                                ...
                                                <p class="text-xs text-gray-500">Tidak ada kelas</p>
                                            </div>
                                        @endif
                                    </div>
                                </div>
