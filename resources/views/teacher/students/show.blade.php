                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <a href="{{ route('teacher.grades.create', ['student_id' => $student->id]) }}"
                            ...
                            <h3 class="mt-3 text-sm font-medium text-gray-900 text-center">Add Grade</h3>
                            <p class="mt-1 text-xs text-gray-500 text-center">Record new grade</p>
                        </a>
                        ...
                        <a href="{{ route('teacher.attendance.create', ['class_id' => $student->class_id]) }}"
                            ...
                            <h3 class="mt-3 text-sm font-medium text-gray-900 text-center">Record Attendance</h3>
                            <p class="mt-1 text-xs text-gray-500 text-center">Mark attendance</p>
                        </a>
                        ...
                        <a href="{{ route('teacher.grades.index', ['student_id' => $student->id]) }}"
                            ...
                            <h3 class="mt-3 text-sm font-medium text-gray-900 text-center">View Grades</h3>
                            <p class="mt-1 text-xs text-gray-500 text-center">All grades history</p>
                        </a>
                        ...
                        <a href="{{ route('teacher.attendance.index', ['student_id' => $student->id]) }}"
                            ...
                            <h3 class="mt-3 text-sm font-medium text-gray-900 text-center">View Attendance</h3>
                            <p class="mt-1 text-xs text-gray-500 text-center">Attendance history</p>
                        </a>
                    </div>
                </div>
            </div>
