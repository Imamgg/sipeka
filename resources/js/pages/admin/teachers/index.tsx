...
export default function Index({ teachers, filters }: Props) {
    ...
    function handleDelete() {
        ...
        router.delete(`/teachers/${deleteId}`, {
            onSuccess: () => {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
                <div className="glass-card border-glow rounded-xl p-6 shadow-sm">
                    ...
                    <p className="text-muted-foreground mt-1">
                        Kelola data guru dengan mudah. Tambahkan, edit, atau hapus guru sesuai kebutuhan Anda.
                    </p>
                </div>
                            ...
                            <table className="w-full border-collapse">
                                <thead>
                                    <tr className="bg-gradient-to-r from-gray-50 to-gray-100 text-left text-sm font-medium text-gray-500 dark:from-gray-700 dark:to-gray-800 dark:text-gray-300">
                                        ...
                                        <th className="px-4 py-3.5 whitespace-nowrap first:pl-6 last:pr-6">NIP</th>
                                        <th className="px-4 py-3.5 whitespace-nowrap">Nama</th>
                                        <th className="hidden px-4 py-3.5 whitespace-nowrap md:table-cell">No. Hp</th>
                                        ...
                                        teachers.data.map((teacher, index) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-4 text-sm whitespace-nowrap first:pl-6 last:pr-6 dark:text-gray-300">
                                                    <div className="font-medium">{teacher.nip}</div>
                                                </td>
                                                <td className="px-4 py-4 text-sm font-medium text-gray-900 dark:text-white">
                                                    <div className="flex flex-col">
                                                        <span>{teacher.name}</span>
                                                        <span className="mt-1 text-xs text-gray-500 sm:hidden">{teacher.email}</span>
                                                    </div>
                                                </td>
                                                <td className="hidden px-4 py-4 text-sm text-gray-600 md:table-cell dark:text-gray-400">
                                            ...
                                            <td colSpan={6} className="px-4 py-10 text-center">
                                                <div className="flex flex-col items-center justify-center">
                                                    ...
                                                    <p className="max-w-md text-sm text-gray-500 dark:text-gray-400">
                                                        Tidak ada data guru yang ditemukan sesuai pencarian Anda
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    {teachers.links && (
                        <div className="mt-6 flex flex-col items-center justify-between gap-4 sm:flex-row">
                            ...
                            <div className="flex flex-wrap justify-center gap-1">
                                {Object.values(teachers.links).map((link: PaginationLink, i) => {
            ...
            <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>Apakah Anda yakin ingin menghapus guru ini? Tindakan ini tidak dapat dibatalkan.</DialogDescription>
                    </DialogHeader>
