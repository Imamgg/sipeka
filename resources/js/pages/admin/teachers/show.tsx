...
import { ArrowLeft, CalendarDays, Clock, Edit, Mail, MapPin, PhoneCall, Trash2, User } from 'lucide-react';
...
export default function Show({ teacher }: Props) {
    ...
    function confirmDelete() {
        router.delete(`/teachers/${teacher.id}`, {
            ...
            onError: (errors) => {
                toast.error(errors.general || 'Gagal menghapus guru');
            },
        });
    }
        ...
        <AppLayout>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
                <div className="glass-card border-glow rounded-xl p-6 shadow-md">
                    ...
                    <p className="text-muted-foreground mt-1 max-w-2xl">Informasi lengkap tentang data guru yang tersimpan dalam sistem.</p>
                </div>
                        ...
                        <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm transition-all hover:shadow dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <dl className="space-y-4">
                                <div className="flex items-start gap-3 rounded-md p-2 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800/60">
                                    <dt className="mt-0.5 w-28 flex-shrink-0 font-medium text-gray-500 dark:text-gray-400">NIP</dt>
                                    <dd className="flex-1 text-gray-900 dark:text-white">{teacher.nip}</dd>
                                </div>
                                ...
                                <div className="flex items-start gap-3 rounded-md p-2 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800/60">
                                    ...
                                    <dd className="flex-1 text-gray-900 dark:text-white">{teacher.email}</dd>
                                </div>
                                ...
                                <div className="flex items-start gap-3 rounded-md p-2 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800/60">
                                    ...
                                    <dd className="flex-1 text-gray-900 dark:text-white">
                                        {teacher.place_of_birth}, {formatDate(teacher.date_of_birth)}
                                    </dd>
                                </div>
                                ...
                                <div className="flex items-start gap-3 rounded-md p-2 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800/60">
                                    ...
                                    <dd className="flex-1 text-gray-900 dark:text-white">{teacher.phone_number || '-'}</dd>
                                </div>
                                ...
                                <div className="flex items-start gap-3 rounded-md p-2 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800/60">
                                    ...
                                    <dd className="flex-1 whitespace-pre-line text-gray-900 dark:text-white">{teacher.address}</dd>
                                </div>
                            </dl>
                        </div>
                        ...
                        <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm transition-all hover:shadow dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <dl className="space-y-4">
                                <div className="flex items-start gap-3 rounded-md p-2 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800/60">
                                    ...
                                    <dd className="flex-1 text-gray-900 dark:text-white">{formatDate(teacher.created_at)}</dd>
                                </div>

                                <div className="flex items-start gap-3 rounded-md p-2 transition-colors hover:bg-gray-100 dark:hover:bg-gray-800/60">
                                    <dt className="mt-0.5 w-28 flex-shrink-0 font-medium text-gray-500 dark:text-gray-400">Diperbarui</dt>
                                    <dd className="flex-1 text-gray-900 dark:text-white">{formatDate(teacher.updated_at)}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
            ...
            <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Apakah Anda yakin ingin menghapus guru <span className="text-foreground font-medium">{teacher.name}</span>? Data yang
