...
export default function Index({ students, filters }: Props) {
    ...
    function handleSearch(e: FormEvent) {
        e.preventDefault();
        router.get('/students', { search: searchText }, { preserveState: true });
    }
                            ...
                            <table className="w-full border-collapse">
                                <thead>
                                    <tr className="bg-gradient-to-r from-gray-50 to-gray-100 text-left text-sm font-medium text-gray-500 dark:from-gray-700 dark:to-gray-800 dark:text-gray-300">
                                        <th className="hidden px-4 py-3.5 whitespace-nowrap lg:table-cell">No</th>
                                                            ...
                                                            <Tooltip>
                                                                <TooltipTrigger asChild>
                                                                    <Button
                                                                        variant="ghost"
                                                                        size="sm"
                                                                        className="h-8 w-8 p-0 text-red-600 transition-all hover:bg-red-100/50 hover:text-red-700 dark:text-red-400 dark:hover:bg-red-900/30"
            ...
            <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                <DialogContent className="sm:max-w-md">
                    ...
                    <DialogFooter className="gap-2 sm:gap-0">
                        <DialogClose asChild>
                            <Button variant="outline" className="transition-all hover:bg-gray-100 dark:hover:bg-gray-700">
                                Batal
                            </Button>
                        </DialogClose>
                        <Button variant="destructive" onClick={handleDelete} className="shadow-sm transition-all hover:shadow">
                            Hapus
                        </Button>
                    </DialogFooter>
                </DialogContent>
