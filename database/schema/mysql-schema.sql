...
CREATE TABLE `announcements` (
  ...
  `target` enum('all','students','teachers') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'all',
...
CREATE TABLE `class_schedules` (
  ...
  CONSTRAINT `class_schedules_teacher_id_foreign` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `materials` (
  ...
  `type` enum('material','assignment') COLLATE utf8mb4_unicode_ci NOT NULL,
  `published_at` date DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_verified_at` timestamp NOT NULL DEFAULT '2025-05-24 20:20:26',
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (15,'2025_05_25_174437_create_server_status_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (16,'2025_05_26_080912_add_verification_status_to_grades_table',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (18,'2025_05_26_081019_add_verification_status_to_presence_details_table',4);
