...
class AdminGradeController extends Controller
{
    ...
    {
        $query = PresenceDetail::with([
            'presence.classSchedule.subject',
            'presence.classSchedule.teacher.user',
            'presence.subject',
            'presence.teacher.user',
            'student.user',
            'student.classes', // Make sure to load student's classes relationship
            'verifier'
        ])->orderBy('created_at', 'desc');
    ...
    public function showAttendance(PresenceDetail $attendance)
    {
        $attendance->load([
            'presence.classSchedule.subject',
            'presence.classSchedule.teacher.user',
            'presence.subject',  // Direct subject relationship as fallback
            'presence.teacher.user',  // Direct teacher relationship as fallback
            'student.user',
            'student.classes', // Make sure to load student's classes relationship
            'verifier'
        ]);
